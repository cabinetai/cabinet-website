...
import { TagBadge } from "@/components/templates/tag-badge";
import { StarButton } from "@/components/templates/star-button";
import { CabinetTree } from "@/components/templates/cabinet-tree";
import { AgentCard } from "@/components/templates/agent-card";
import { JobCard } from "@/components/templates/job-card";
import { InstallCommand } from "@/components/templates/install-command";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${entry.meta.name} template | Cabinet`,
