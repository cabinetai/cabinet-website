...
/**
 * "Fresh from the workshop" is the curated new-template drop, arranged as
 ...
 *
 * Pure CSS hover keeps the whole section a
 ...
 * server component. On touch devices, the gradient face remains the card and
 * the screenshot is available on the detail page.
 */
    ...
    <Link href={`/templates/${t.slug}`} className="group block">
      <div className="relative aspect-[16/10] overflow-hidden rounded-2xl shadow-sm transition-shadow duration-300 group-hover:shadow-xl">
        ...
        >
          ...
          <span className="absolute bottom-4 left-5 right-5 font-display text-2xl leading-tight text-white [text-shadow:0_1px_8px_rgba(0,0,0,0.18)]">
            {t.name}
          </span>
        </div>
        {/* Screenshot reveal */}
