...
export const MACOS_DOWNLOAD_URL =
  "https://github.com/hilash/cabinet/releases/download/v0.5.0/Cabinet-0.5.0-arm64.dmg";
export const WINDOWS_DOWNLOAD_URL =
  "https://github.com/hilash/cabinet/releases/download/v0.5.0/Cabinet-0.5.0.Setup.exe";
